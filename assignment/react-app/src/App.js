...
//   render(){
//     console.log('menu: ' + this.state.selectedMenu)
//     return (
//       <div className="App">
//           <p className="menu-item" onClick={() => this.setState({ selectedMenu: 'a' })}><h3>AboutMe</h3></p>
//           <p className="menu-item" onClick={() => this.setState({ selectedMenu: 't' })}><h3>Town</h3></p>
//           <p className="menu-item" onClick={() => this.setState({ selectedMenu: 'w' })}><h3>Weather</h3></p>
